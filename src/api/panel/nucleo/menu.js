...
const QUE_ABRE = {
  ...
  'deportes.ver':         { menu: 'Deportes · Procesos automáticos · Análisis deportivo · Histórico deportivo', abre: true },
...
const ICONOS_MENU = {
  ...
  procesosAutomaticos: '<path d="M4 7h10M18 7h2M4 17h2M10 17h10"/><circle cx="16" cy="7" r="2"/><circle cx="8" cy="17" r="2"/><path d="M4 12h16"/>',
  analisisDeportivo: '<path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/><circle cx="18" cy="6" r="2"/>',
...
const SECCIONES = [
  ...
  { id:'procesosAutomaticos', nombre:'Procesos automáticos', permiso:'deportes.ver' },
  { id:'analisisDeportivo', nombre:'Análisis deportivo', permiso:'deportes.ver' },
